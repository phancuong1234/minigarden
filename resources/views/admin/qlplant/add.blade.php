...
<div class="content-wrapper">
   <div class="container">
      <div class="row pad-botm">
         <div class="col-md-12">
            <h4 class="header-line">Thêm Cây Trồng</h4>
         </div>
      </div>
      <div class="row">
         <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="panel panel-info">
               ...
               <div class="panel-body">
                  <form role="form" action="{{Route('admin.plant.add')}}" enctype="multipart/form-data" method="post" class="form">
                     {{ csrf_field() }}
                     ...
                     <div class="form-group">
                        ...
                        <input class="form-control" type="text" name="temp" value="" />
                        @if($errors->has('temp'))
                     ...
                     <div class="form-group">
                        <label>Độ Ẩm</label>
                        <input class="form-control" type="text" name="humadity" value="" />
                     ...
                     <div class="form-group">
                        ...
                        <input class="form-control" type="text" name="light" value="" />
                        @if($errors->has('light'))
